...
const CourseCard = ({ icon, subject, description }) => {
  return (
    <div className="h-full border-2 rounded-xl border-b-4 hover:bg-black/5 cursor-pointer active:border-b-2 flex flex-col items-center justify-center p-3 gap-y-2 pb-6 min-h-[217px]">
